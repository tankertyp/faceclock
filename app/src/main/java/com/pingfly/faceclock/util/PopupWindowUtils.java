...
public class PopupWindowUtils {
     ...
     * @return
     */
    public static PopupWindow getPopupWindowAsDropDownParentAuto(View contentView, int width, int height, View anchorView, AppCompatActivity activity) {
     ...
     * @return
     */
    private static boolean isShowBottom(AppCompatActivity context, View itemView) {
        // 得到屏幕的高度
        // int heightPixels =
     ...
     * 使window变暗
     */
    public static void makeWindowDark(AppCompatActivity activity) {
        makeWindowDark(activity, 0.7f);
    }

    public static void makeWindowDark(AppCompatActivity activity, float alpha) {
     ...
     * 使window变亮
     */
    public static void makeWindowLight(AppCompatActivity activity) {
        WindowManager.LayoutParams lp = activity.getWindow().getAttributes();
        lp.alpha = 1f;
        activity.getWindow().setAttributes(lp);
    }
