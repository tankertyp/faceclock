...
public class ConsUtils {
    ...
    public static final int UPDATAE_ALARM=8;
    ...
    //public static final String SQLDB_NAME="china_Province_city_zone.db";
    ...
    //天气模块
    public static final String WEATHER_API_KEY="secret";//请求接口的key
    public static final int[] WEATHER_IMG_DAY=new int[]{
    ...
    public static final int[] WEATHER_IMG_NIGHT=new int[]{
    ...
    public static final int[] WEATHER_IMG_FUTURE=new int[]{
    ...
    //Pref
    public static final String SHOULD_WEATHER_CLOSE="shouldwetherclose";//是否不显示天气
