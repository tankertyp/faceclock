package com.pingfly.faceclock.api.base;


import com.pingfly.faceclock.api.base.persistentcookiejar.ClearableCookieJar;
import com.pingfly.faceclock.api.base.persistentcookiejar.PersistentCookieJar;
import com.pingfly.faceclock.api.base.persistentcookiejar.cache.SetCookieCache;
import com.pingfly.faceclock.api.base.persistentcookiejar.persistence.SharedPrefsCookiePersistor;
...
//        loggingInterceptor.setLevel(HttpLoggingInterceptor.Level.NONE);//这里可以选择拦截级别
        ...
        // PersistentCookieJar作用：持久化Cookie
        //Cookie与Session的区别
        ...
        //cookie
        //使用 PersistentCookieJar实现用户信息cookie持久化
