...
public interface MyApi {
    ...
    Observable<CheckEmailResponse> checkEmailAvailable(@Body RequestBody body);
    ...
    //发送验证码
    @POST("user/send_code_by_email")
    Observable<SendCodeByEmailResponse> sendCodeByEmail(@Body RequestBody body);
