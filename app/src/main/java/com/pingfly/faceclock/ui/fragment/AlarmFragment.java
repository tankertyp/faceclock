...
import com.pingfly.faceclock.ui.activity.AddAlarmActivity;
...
import com.pingfly.faceclock.alarmclock.receiver.BootReceiver;
import com.pingfly.faceclock.alarmclock.util.ConsUtils;
import com.pingfly.faceclock.alarmclock.util.PrefUtils;
import com.pingfly.faceclock.ui.base.AlarmBaseFragment;
import com.pingfly.faceclock.util.LogUtils;

import java.util.List;


public class AlarmFragment extends AlarmBaseFragment {
    ...
    private void toggleMenu(View view) {
        LogUtils.d("alarm","此时的菜单打开情况"+isMenuOn);
        ...
        LogUtils.d("alarm", "后面宽" + ll_button.getWidth() + "前面" + rl_main.getWidth());
        ...
        LogUtils.d("alarm", "点击后的菜单打开情况" + isMenuOn);
    }
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            LogUtils.d("alarm",alarmInfo.toString()+"id:"+alarmInfo.getId());
            return convertView;
        }
