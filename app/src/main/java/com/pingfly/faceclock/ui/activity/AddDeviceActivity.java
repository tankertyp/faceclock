    ...
    private void initReceiver() {
        ...
        mBtStateReceiver = new BtStateReceiver(){
            ...
            public void OnBtStateOFF() {
                ...
                Toast.makeText(AddDeviceActivity.this, "你已经进入了没有蓝牙的异次元...aaa", Toast.LENGTH_SHORT).show();
            }
            ...
            public void OnAccept(final BluetoothDevice device) {
                ...
                builder.setPositiveButton("开始聊天", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = BluetoothCommActivity.getIntentStartActivity(AddDeviceActivity.this, device.getName());
...
//                }
            ...
            public void onSearchCompleted(List<BluetoothDevice> bondedList, List<BluetoothDevice> newList) {
                ...
                isSearching = false;
                Toast.makeText(AddDeviceActivity.this, "搜索完毕...qwq", Toast.LENGTH_SHORT).show();
                Log.d("TAG", " search ok");
            }
            ...
            public void onItemClick(final int position) {
                ...
                mBtHelper.connectDevice(device.getDeviceAddress(), new IConnectionListener() {
                    ...
                    public void OnConnectionSuccess() {
                        ...
                        Toast.makeText(AddDeviceActivity.this, "配对成功...hhh", Toast.LENGTH_SHORT).show();
                        Log.d("TAG", "配对成功");
...
//                        mDevice = devices.get(position);
                    ...
                    public void OnConnectionFailed(Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(AddDeviceActivity.this, "配对失败...zzZ", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.action_send:
                Intent intent = BluetoothCommActivity.getIntentStartActivity(AddDeviceActivity.this, mDevice.getDeviceName());
                startActivity(intent);
                break;
    ...
    private void invisibleSendAndChangeItemState() {
        ...
        if( menuItem.isVisible() ){
            ...
            for(DataItem dataItem: dataItems){
                if(dataItem.getType()==AppConst.DATA_TYPE_DEVICE_NEW || dataItem.getType() == AppConst.DATA_TYPE_DEVICE_BONDED){
