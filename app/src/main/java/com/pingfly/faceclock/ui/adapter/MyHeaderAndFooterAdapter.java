 ...
 */
public class MyHeaderAndFooterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyHeaderAndFooterAdapter(RecyclerView.Adapter innerAdapter) {
